...
from lib.helpers.ema import ModelEMA


parser = argparse.ArgumentParser(description='Spatial-Projection Alignment for Monocular 3D Object Detection')
...
def main():
    ...
    ema_model = ModelEMA(model, decay=0.9999, warmups=2000) if cfg['use_ema'] else None
